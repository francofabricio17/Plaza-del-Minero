...
(function () {
    ...
    console.log("Historia interactiva cargada.");
    ...
    function crearInterfaz() {
        ...
        if (botonSiguiente) {
            botonSiguiente.onclick = siguientePaso;
        }

        if (botonExplorar) {
            botonExplorar.onclick = terminarHistoria;
        }
    }
    ...
    function mostrarPaso(indice) {
        ...
        historiaProgreso.innerText =
            (indice + 1) + " / " + historia.length;

        historiaProgresoFill.style.width =
            ((indice + 1) / historia.length * 100) + "%";
    ...
    function terminarHistoria() {
        ...
        // GUARDAR QUE LA HISTORIA YA FUE VISTA
